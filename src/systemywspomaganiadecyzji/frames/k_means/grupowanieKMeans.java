...
public class grupowanieKMeans extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        kms.group(Data.getInstance().getData(columnSelected), Data.getInstance().getStringColumn(jComboBox3.getSelectedIndex()), Integer.parseInt(neighbourCountTextField.getText()));
